...
number of points a soccer team has earned so far this season.
The user enters the points earned for each game, then enters -1 when finished
...
int main()
{
	...
	int game = 1,  //Game counter
            ...
            total = 0; //Accumulates the total points for all games

        //Read in the points for game!
